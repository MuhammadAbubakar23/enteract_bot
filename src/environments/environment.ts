export const environment = {
    ...
    link:{
      analytics:{
        ...
        getTotalAgents:'analytics/total_bots_agent?bot_id=6',
        avgBotConversationTime:'analytics/avg_bot_conversation_time?bot_id=6&filter_days=7',
        botEsclationRate:'analytics/bot_escalation_rate?bot_id=6&filter_days=7',
        avgWaitTime:'analytics/avg_wait_time?bot_id=6&filter_days=7',
        sentimentAnalysis:'analytics/sentiments_analysis_bot_csat?bot_id=6&filter_days=7',
        tagsAnalatics:'analytics/tags_analytics?bot_id=6&filter_days=7',
        peakHours:'analytics/peak_hours?bot_id=6',
        totalToken:'analytics/total_tokens?bot_id=6&filter_days=7',
        avgToken:'analytics/average_tokens_per_conversation?bot_id=6&filter_days=7',
        timeoutCount:'analytics/session_time_out?bot_id=6&filter_days=7',
        tokenPerDay:'analytics/tokens_per_day?bot_id=6',
